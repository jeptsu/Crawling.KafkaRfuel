...
{
    public class KafkaRfuel_Command_MeshProcessor : BaseMeshProcessor
    {
        public KafkaRfuel_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          KafkaRfuelConstants.ProviderId;
