...
{
    public class DataIngestion : IClassFixture<KafkaRfuelTestFixture>
    {
        private readonly KafkaRfuelTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(KafkaRfuelTestFixture fixture, ITestOutputHelper output)
        {
